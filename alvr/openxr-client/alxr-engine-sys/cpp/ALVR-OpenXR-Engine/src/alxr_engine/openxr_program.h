...
struct ALXREyeInfo;
struct TrackingInfo;
struct ALXREyeTrackingInfo;
struct ALXRFaceTrackingInfo;
...
struct IOpenXrProgram {
    ...
    virtual bool PollEyeTracker(ALXREyeTrackingInfo& ALXREyeTrackingInfo) = 0;
    virtual bool PollFaceTracker(ALXRFaceTrackingInfo& ALXRFaceTrackingInfo) = 0;
